...
public class TinyDB {
    ...
    public ArrayList<MusicDeviceOrder> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<MusicDeviceOrder> plist =  new ArrayList<MusicDeviceOrder>();

        for(String jObjString : objStrings){
            MusicDeviceOrder item  = gson.fromJson(jObjString,  MusicDeviceOrder.class);
            plist.add(item);
        }
        return plist;
    }
    ...
    public void putListObject(String key, ArrayList<MusicDeviceOrder> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(MusicDeviceOrder player: playerList){
